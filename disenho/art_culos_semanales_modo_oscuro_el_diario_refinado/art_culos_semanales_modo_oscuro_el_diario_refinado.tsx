...
export default function ArtCulosSemanalesModoOscuroElDiarioRefinado() {
  return (
    <>

{/*  TopNavBar  */}
<nav className="bg-surface-container border-b border-outline-variant w-full px-margin-mobile md:px-margin-desktop py-4 sticky top-0 z-50">
<div className="flex justify-between items-center w-full max-w-container-max mx-auto">
{/*  Navigation Links  */}
<div className="hidden md:flex gap-6 items-center">
<a className="font-label-md text-label-md text-on-surface-variant tracking-widest hover:text-primary transition-colors duration-300" href="#">Philosophy</a>
<a className="font-label-md text-label-md text-on-surface-variant tracking-widest hover:text-primary transition-colors duration-300" href="#">Economics</a>
<a className="font-label-md text-label-md text-on-surface-variant tracking-widest hover:text-primary transition-colors duration-300" href="#">Politics</a>
<a className="font-label-md text-label-md text-on-surface-variant tracking-widest hover:text-primary transition-colors duration-300" href="#">Literature</a>
<a className="font-label-md text-label-md text-on-surface-variant tracking-widest hover:text-primary transition-colors duration-300" href="#">Reflections</a>
</div>
...
{/*  Brand Logo  */}
<a className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg text-on-background tracking-tighter absolute left-1/2 -translate-x-1/2" href="#">The Journal</a>
{/*  Trailing Action  */}
<div className="flex items-center gap-4">
<button className="text-on-surface hover:text-primary transition-colors duration-300 hidden md:block">
...
<span className="font-label-md text-label-md text-primary uppercase tracking-widest">Philosophy • Featured</span>
<h1 className="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg text-on-background cursor-pointer hover:text-primary transition-colors duration-300">
...
<h2 className="font-headline-sm text-headline-sm text-on-background mb-8 text-center uppercase tracking-widest">The Columnists</h2>
...
<span className="font-label-md text-label-md text-on-surface uppercase tracking-widest mb-1">Alistair Sterling</span>
<h3 className="font-headline-md text-[20px] leading-[28px] text-on-surface-variant group-hover:text-primary transition-colors duration-300">The Economics of Scarcity</h3>
</div>
{/*  Writer 2  */}
<div className="flex flex-col items-center text-center group cursor-pointer">
<div className="w-24 h-24 rounded-full overflow-hidden mb-4 border border-outline-variant p-1">
...
<span className="font-label-md text-label-md text-on-surface uppercase tracking-widest mb-1">Miriam Rothschild</span>
<h3 className="font-headline-md text-[20px] leading-[28px] text-on-surface-variant group-hover:text-primary transition-colors duration-300">Political Fictions</h3>
</div>
{/*  Writer 3  */}
<div className="flex flex-col items-center text-center group cursor-pointer">
<div className="w-24 h-24 rounded-full overflow-hidden mb-4 border border-outline-variant p-1">
...
<span className="font-label-md text-label-md text-on-surface uppercase tracking-widest mb-1">Julian Thorne</span>
<h3 className="font-headline-md text-[20px] leading-[28px] text-on-surface-variant group-hover:text-primary transition-colors duration-300">Notes on the Vernacular</h3>
</div>
{/*  Writer 4  */}
<div className="flex flex-col items-center text-center group cursor-pointer">
<div className="w-24 h-24 rounded-full overflow-hidden mb-4 border border-outline-variant p-1">
...
<span className="font-label-md text-label-md text-on-surface uppercase tracking-widest mb-1">Beatrice Owe</span>
<h3 className="font-headline-md text-[20px] leading-[28px] text-on-surface-variant group-hover:text-primary transition-colors duration-300">Reflections at Dusk</h3>
</div>
</div>
</section>
{/*  Article Grid  */}
...
<span className="font-label-md text-label-md text-primary uppercase tracking-widest mb-3">Politics</span>
<h3 className="font-headline-md text-headline-md text-on-background mb-3 group-hover:text-primary transition-colors duration-300 line-clamp-3">
...
{/*  Article Card 2  */}
<article className="flex flex-col group cursor-pointer">
<span className="font-label-md text-label-md text-primary uppercase tracking-widest mb-3">Literature</span>
<h3 className="font-headline-md text-headline-md text-on-background mb-3 group-hover:text-primary transition-colors duration-300 line-clamp-3">
...
{/*  Article Card 3  */}
<article className="flex flex-col group cursor-pointer">
<span className="font-label-md text-label-md text-primary uppercase tracking-widest mb-3">Economics</span>
<h3 className="font-headline-md text-headline-md text-on-background mb-3 group-hover:text-primary transition-colors duration-300 line-clamp-3">
...
<span className="font-label-md text-label-md text-primary uppercase tracking-widest mb-3">Reflections</span>
<h3 className="font-display-lg-mobile md:text-[40px] md:leading-[48px] font-headline-md text-on-background mb-4 group-hover:text-primary transition-colors duration-300">
...
{/*  Article Card 5  */}
<article className="flex flex-col group cursor-pointer">
<span className="font-label-md text-label-md text-primary uppercase tracking-widest mb-3">Philosophy</span>
<h3 className="font-headline-md text-headline-md text-on-background mb-3 group-hover:text-primary transition-colors duration-300 line-clamp-3">
...
<a className="font-headline-sm text-headline-sm text-on-background" href="#">The Journal</a>
<p className="font-label-sm text-label-sm text-on-surface-variant max-w-xs">
                    Intellectual and philosophical discourse.
                </p>
</div>
<div className="flex flex-col gap-4">
<h4 className="font-label-sm text-label-sm text-on-surface uppercase tracking-widest">Navigation</h4>
<nav className="flex flex-col gap-2">
<a className="font-body-md text-body-md text-on-surface-variant hover:text-primary underline decoration-1 underline-offset-4 transition-all duration-200" href="#">About</a>
<a className="font-body-md text-body-md text-on-surface-variant hover:text-primary underline decoration-1 underline-offset-4 transition-all duration-200" href="#">Archives</a>
<a className="font-body-md text-body-md text-on-surface-variant hover:text-primary underline decoration-1 underline-offset-4 transition-all duration-200" href="#">Authors</a>
<a className="font-body-md text-body-md text-on-surface-variant hover:text-primary underline decoration-1 underline-offset-4 transition-all duration-200" href="#">Masthead</a>
<a className="font-body-md text-body-md text-on-surface-variant hover:text-primary underline decoration-1 underline-offset-4 transition-all duration-200" href="#">Privacy</a>
</nav>
</div>
<div className="flex flex-col gap-4 max-w-xs">
<h4 className="font-label-sm text-label-sm text-on-surface uppercase tracking-widest">Newsletter</h4>
...
<input className="bg-transparent border-b border-outline-variant focus:border-primary focus:ring-0 px-0 py-2 w-full font-body-md text-body-md text-on-surface placeholder:text-on-surface-variant outline-none rounded-none" placeholder="Email address" type="email"/>
<button className="font-label-sm text-label-sm text-primary uppercase tracking-widest ml-4 hover:text-primary-fixed-dim transition-colors duration-300" type="submit">Submit</button>
</form>
</div>
</div>
