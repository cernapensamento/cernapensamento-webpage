  ...
  return (
    <div className="min-h-screen bg-parchment flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full border border-lines bg-white p-12 text-center">
        ...
        <h2 className="font-serif text-2xl text-charcoal mb-4">Página Extraviada</h2>
        ...
        <Link
          href="/"
          className="inline-block px-6 py-3 bg-charcoal text-white text-sm font-semibold uppercase tracking-widest hover:bg-black transition-colors"
        >
