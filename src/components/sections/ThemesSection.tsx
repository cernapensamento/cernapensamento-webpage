...
export default function ThemesSection({ lang, dict }: ThemesSectionProps) {
  ...
  return (
    <section className="w-full py-24 bg-parchment text-charcoal border-t border-lines">
      <div className="max-w-[1000px] mx-auto px-5 md:px-0 text-center">
        <span className="text-sm font-semibold text-gold uppercase tracking-widest block mb-6">{dict.tag}</span>
