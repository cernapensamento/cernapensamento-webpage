  ...
  return (
    <section className="w-full py-24 bg-charcoal dark:bg-parchment relative overflow-hidden">
      ...
      <div className="max-w-[800px] mx-auto px-5 md:px-16 text-center flex flex-col items-center">
        ...
        <h2 className="font-serif text-4xl md:text-5xl text-parchment dark:text-charcoal mb-8">Hablemos</h2>
        
        <p className="font-sans text-lg text-parchment/70 dark:text-charcoal/70 leading-relaxed mb-12 max-w-2xl">
          ¿Tienes alguna propuesta, duda o deseas colaborar con {SITE_NAME}? 
          Nos encantaría escuchar tus ideas. Escríbenos directamente a nuestro buzón y nos pondremos en contacto contigo.
        </p>

        <a 
          href="mailto:administracion@cerna.com" 
        ...
        >
          ...
          <span>administracion@cerna.com</span>
        </a>
