        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-8 bg-surface-container-lowest p-8 md:p-12 border border-lines relative shadow-sm">
            ...
            <div>
                ...
                <textarea
                    ...
                    className="w-full p-3 border border-lines bg-surface-bright font-sans text-charcoal focus:ring-0 focus:border-charcoal resize-y transition-colors"
                ></textarea>
                ...
                <div className="flex items-start mb-8">
                    <div className="flex items-center h-5">
                        <input
                            ...
                            className="h-4 w-4 border border-lines rounded-none text-charcoal focus:ring-charcoal"
                        />
                    </div>
                    <div className="ml-3 text-sm">
                        <label htmlFor="guidelines" className="font-sans text-xs text-charcoal">
                            {dict.agreement}
                        </label>
